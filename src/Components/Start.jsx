...
export default function Start({ handlePage }) {
  return (
    <div className="w-full flex flex-col items-center space-y-8 md:space-x-12 md:flex-row max-w-2xl mx-auto p-6 bg-white rounded-2xl shadow-lg mt-8">
      <div className="">
        <Title />
        <div className="flex flex-col items-center justify-center space-y-4 mt-10">
          <p className="text-xl">
            سلام به سایت ما خوش اومدی اینجا میتونی شانستو امتحان کنی تا به
            جاییزه بزرگ برسی.
          </p>
